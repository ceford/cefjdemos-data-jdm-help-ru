...
- **Общая сессия** Когда включено, сессия пользователя делится между разделами Frontend и Backend сайта. Обратите внимание, что изменение этого значения аннулирует все существующие сессии на сайте. Это недоступно, когда опция *Force HTTPS* установлена для *только для администраторов*.
