<!-- Filename: Help4.x:Site_Modules:_Custom / Display title: Модули: HTML-код -->

## Описание

Модуль "HTML-код" позволяет вам создать автономный HTML-блок, а затем
поместить его в любое допустимое место на странице.
...
<img
src="https://docs.joomla.org/images/5/5a/Help-4x-modules-site-module-manager-module-custom-html-en.png"
...
An example of a Custom HTML message is shown below.
...
In this example the custom module would be *Unpublished* after the
software update.
